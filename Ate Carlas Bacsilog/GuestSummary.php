...
<br><br>
<h3 class="title" style="color: #AF1D27; text-align: center;">Shopping Cart Summary</h3>
<h6 style="text-align: center;">Summary of your order</h6>
<h3 class="title" style="width:25%;margin-left:8%;margin-right:92%;"><strong>Shopping Cart Details</strong></h3>
<!-- Table of Summary -->
 <table class="table table-hover text-center border" style="width:80%;margin-left:auto;margin-right:auto;" >
	...
	<tbody>
		...
		<tr><!-- Example only -->
			<td>Cheesy Angus Beef Burger</td>
			<td>₱95</td>
			<td>1</td>
			<td>₱95</td>
		</tr>
  ...
  <tfoot>
		...
		<tr>
			<td class="total" colspan="3">Delivery Fee</td>
			<td>₱50</td>
		</tr>
		<tr>
			<td class="total" colspan="3"><strong>Order Total</strong></td>
			<td>₱315</td>
		</tr>
  </tfoot>
...
<hr>
<h3 class="title info">Mode of Payment</h3>	
<div class="top">
...
<div class=" btn col-sm-12 d-flex align-items-center justify-content-center">
									<a href="" type="submit" class="btn btn-outline-dark2 title text-white" style=" background-color: #AF1D27; box-shadow: rgba(0, 0, 0, 0.45) 0px 25px 20px -20px; width: 180px; height: 50px; border: none;  border-radius: 50px;">
										<div style="margin-top: 6px; font-weight: 600; font-size: 17px; letter-spacing: 1.5px;">
											Confirm Order
										</div>
									</a>
									&nbsp;
									<a href="GuestCheckout.php" class="btn btn-outline-dark2 title text-white" style=" background-color: #474747; box-shadow: rgba(0, 0, 0, 0.45) 0px 25px 20px -20px; width: 180px; height: 50px; border: none;  border-radius: 50px;">
										<div style="margin-top: 6px; font-weight: 600; font-size: 17px; letter-spacing: 1.5px;">
											Go Back
										</div>
									</a>
