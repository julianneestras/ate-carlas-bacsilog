      ...
      if(isset($_POST['submit']))
{
    ...
    if(! $query_run){
        ...
        header('refresh:0;url=adminproducts.php?q=1#dashboard?q=1');
      ...
      if(isset($_POST['deleteprod']))
{
      ...
      $querydelete = "DELETE FROM $Category WHERE Food_ID='$ProdID'";
      $query_run = mysqli_query($conn, $querydelete);
      if($query_run)
    {
        echo "<center><h3><script>alert('Product Deleted!');</script></h3></center>";
        header('refresh:0;url=admindashboard.php?q=1#dashboard?q=1');
    }
    else
    {
...
<?php
   if(isset($_GET['page']))
    ...
    $query = "SELECT Food_ID, Category, Food, Quantity, Price FROM muncheese UNION ALL SELECT Food_ID, Category, Food, Quantity, Price FROM silog UNION ALL SELECT Food_ID, Category, Food, Quantity, Price FROM desserts UNION ALL SELECT Food_ID, Category, Food, Quantity, Price FROM sandwhiches limit $start_from,$num_per_page";
        ...
        <div class="row jumbotron">
                ...
                ?>
                    <div class="col-sm-3 form-group">
                          ...
                          <input type="text" class="form-control input2" name="Food_ID" id="prodID" value="<?= $row['Food_ID']; ?>" required placeholder="Product ID">
                      </div>
                      <div class="col-sm-7 form-group">
                       ...
                       <div class="col-sm-6 form-group">
                          ...
                          <input type="text" class="form-control input2" name="Food" id="prodName" value="<?= $row['Food']; ?>" required placeholder="Product Name" readonly ondblclick="onDoubleClick(this)" onblur="lostFocus(this)">
                      </div>
                      <div class="col-sm-6 form-group">
                          <label for="name-l">Category</label>
                          <input type="text" class="form-control input2" name="Category" id="category" value="<?= $row['Category']; ?>" placeholder="Category">
                      </div>
                      <div class="col-sm-3 form-group">
                          <label for="qty">Quantity</label>
                           <input name = "Quantity" type = "text" 
                            id = "qty" value="<?= $row['Quantity']; ?>" required placeholder="Quantity" readonly ondblclick="onDoubleClick(this)" onblur="lostFocus(this)">
                      </div>
                      <div class="col-sm-3 form-group">
                          <label for="price">Price</label>
                          <input type="text" class="form-control  input2" name="Price" id="price" value="<?= $row['Price']; ?>" required placeholder="Price" readonly ondblclick="onDoubleClick(this)" onblur="lostFocus(this)">
                      </div>
            ...
            <p align="center"><br>
                ...
                $pr_query = "SELECT Food_ID, Category, Food, Quantity, Price FROM muncheese UNION ALL SELECT Food_ID, Category, Food, Quantity, Price FROM silog UNION ALL SELECT Food_ID, Category, Food, Quantity, Price FROM desserts UNION ALL SELECT Food_ID, Category, Food, Quantity, Price FROM sandwhiches";
                ...
                if($page>1)
                {
                    echo "<a href='adminproducts.php?page=".($page-1)."' class='btn btn-danger' style='background: #8f8f8f; border-radius: 5vh; border: 0px solid; font-weight: bold'><i class='fa-solid fa-angle-left'></i></a>";
                ...
                {
                    echo "<a href='adminproducts.php?page=".$i."' class='btn btn-primary' style='color: #8f8f8f; font-size: 14.5px; font-family: Poppins; font-weight: bold; background-color: transparent; border: 0px solid; margin: 5px;'>$i</a>";

                }

                if($i>$page)
                {
                    echo "<a href='adminproducts.php?page=".($page+1)."' class='btn btn-danger' style='background: #8f8f8f; border-radius: 5vh; border: 0px solid; font-weight: bold;'><i class='fa-solid fa-angle-right'></i></a>";
                }
