            ...
            <tr>
              <td>
                <center>
                  ...
                  <br><br>
                  <a href="index.php"><input type="button" name="sendlink" value="CANCEL" style="background-color: transparent; border: 1px solid #1c1c1c; color: #1c1c1c; box-shadow: none"></a>
                  <input onclick="launch_toast()" type="submit" name="sendlinkpass" value="SEND ME AN EMAIL" style="box-shadow: none" required>
