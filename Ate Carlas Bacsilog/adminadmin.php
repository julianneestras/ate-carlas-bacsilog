...
if(empty($AdminID) || empty($AdminFName) || empty($AdminLName) ||empty($AdminGender) || empty($AdminDOB) || empty($AdminAGE) || empty($AdminPhonenum) || empty($Adminemail) || empty($AdminUser) || empty($Adminpassword)){

      $fieldsempty = 'Please do not leave empty fields.';

    }else if (strlen($AdminFName) < 2){
                
          $prodnameerror = 'First Name must not be less than 2 characters.';

    }else if (strlen($AdminLName) < 2){
                
          $prod2nameerror = 'Last Name must not be less than 2 characters.';

    }else if (strlen($AdminUser) < 2){
                
          $usernameerror = 'Username must not be less than 2 characters.';

    }else if(preg_match('/[\'\/~`\!@#\$%\^&\*\(\)_\-\+=\{\}\[\]\|;:"\<\>,\.\?\\\]/', $AdminFName,$AdminLName)){
    ...
    }elseif((!$uppercase) || (!$lowercase) || (!$number) || (!$specialchars) || (strlen($Adminpassword) < 8)){
    ...
    $query = "UPDATE admintable SET First_Name='$AdminFName', Last_Name='$AdminLName', Gender='$AdminGender', DOB='$AdminDOB' ,Age='$AdminAGE',Phone_no='$AdminPhonenum',
      Email='$Adminemail',Username='$AdminUser',Password='$Adminpassword' WHERE Admin_ID='$AdminID'";
...
if(! $query_run){
        ...
        header('refresh:0;url=adminadmin.php?q=1#dashboard?q=1');
...
<?php
   ...
   if(isset($_GET['page']))
    ...
    $query = "SELECT * FROM admintable limit $start_from,$num_per_page";
        ...
        <div class="row jumbotron">
                ...
                ?>
                    <div class="col-sm-3 form-group">
                          ...
                          <input type="text" class="form-control input2" name="AdminID" id="name-f" placeholder="Admin ID" readonly>
                      </div>
                      <div class="col-sm-7 form-group">
                       ...
                       <div class="col-sm-6 form-group">
                          ...
                          <input type="text" class="form-control input2" name="AdminFname" id="name-f" placeholder="First Name" readonly>
                      </div>
                      <div class="col-sm-6 form-group">
                          <label for="name-l">Last Name</label>
                          <input type="text" class="form-control input2" name="AdminLname" id="name-l" placeholder="Last Name" readonly>
                      </div>
                      <div class="col-sm-6 form-group">
                      ...
                      <div class="col-sm-4 form-group">
                          <label for="Date">Date Of Birth</label>
                           <input name = "AdminBirthday" type = "text" 
                            id = "date" onfocus="(this.type='date')" class="input2" onblur="getAge();" max="2004-06-30" min="1923-01-01" placeholder="Birthdate" readonly>
                      </div>
                      <div class="col-sm-2 form-group">
                          <label for="age">Age</label>
                          <input type="number" class="form-control  input2" name="AdminAge" id="u_Age"  maxlength="2"readonly placeholder="Age" readonly>
                          <br><br>
                      </div>
                      <div class="col-sm-6 form-group">
                          <label for="phone">Phone Number</label>
                          <input type="tel" class="form-control input2" name="Adminphonenum" id="phonenum" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" placeholder="1234-567-8901" readonly ondblclick="onDoubleClick(this)" onblur="lostFocus(this)">
                      </div>
                      <div class="col-sm-6 form-group">
                          <label for="email">Email</label>
                          <input type="email" class="form-control input2" name="Adminemail" id="email" placeholder="Email" readonly ondblclick="onDoubleClick(this)" onblur="lostFocus(this)">
                      </div>
                    
                      <div class="col-sm-6 form-group">
                          <label for="tel">Username</label>
                          <input type="tel" name="Adminuser" class="form-control input2" id="tel" placeholder="Username" readonly>
                      </div>
                      <div class="col-sm-6 form-group">
                        <div class="input-icons">
                          <label for="pass">Password</label>
                          <input type="password" name="Adminpassword" class="input2" id="password-field" placeholder="Password" readonly>
